...
const TeamDetails = () => {
  ...
  for (let i = 0; i < starPlayers.length; i++) {
    arrayStarPlayers.push(
      <div
        key={starPlayers[i].player.id}
            ...
            >
              ...
              <span
                className={`px-4 py-1 rounded-full text-sm font-semibold ${
                    game.team1.name === team.name && game.winTeam
