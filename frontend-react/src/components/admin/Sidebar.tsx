...
import { FaInfoCircle, FaUsers, FaBaseballBall, FaUserAlt, FaListAlt, FaHandshake } from "react-icons/fa"; // Añadir FaBaseballBall
...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, setActiveSection }) => {
    const icons = [FaInfoCircle, FaUsers, BiCalendar, FaBaseballBall, FaUserAlt, FaListAlt, FaHandshake];
